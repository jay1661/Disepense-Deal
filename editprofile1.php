<?php
    ...
    $id=$_GET['id'];
    $qrya="SELECT * FROM user_registration where u_id=$id";
    ...
    <div class="container">       
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
               <form action="updateprofile1.php" method="POST" enctype="multipart/form-data" class="contact-form form-group"> 
                <center><h1>User Registration</h1></center>
                <p>Name:</p>
                <input type="text" name="name" placeholder="Enter Your Name" class="form-control" value="<?php echo $rowa['u_name'] ?>"><br>
                <p>Password:</p>
                <input type="password" name="pass" placeholder="Enter Your password" class="form-control" value="<?php echo $rowa['u_password'] ?>"><br><br>
                <p>Photo:</p>
                <input type="file" name="profile" class="form-control"><br>
                <p>Email:</p>
                <input type="email" name="mail" placeholder="Enter Your Email" class="form-control" value="<?php echo $rowa['u_email'] ?>"><br>
                <p>Mobile No.:</p>
                <input type="text" name="num" placeholder="Enter Your Phone Number" value="<?php echo $rowa['u_phone_no'] ?>">
                <p>Address:</p>
                <textarea name="message" placeholder="Enter Your Address"><?php echo $rowa['u_address'] ?></textarea><br><br>
                <p>Area:</p>
                ...
                <p>Answer</p>
                <input type="text" name="ans" placeholder="Enter Your Answer" class="form-control" value="<?php echo $rowa['u_answer'] ?>"><br>

<?php
    ...
    $id=$_GET['id'];
    $qryc="SELECT * FROM parcel_type where p_type_id=$id";
...
<div class="row">
    <div class="col-md-12">
        <form name="qryform" id="qryform" method="POST" action="updatecategory.php" onsubmit="return(validate());" novalidate="novalidate">
            <div class="form-group">
                <label>Type:</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Parcel Type" name="ptype" value="<?php echo $rowc['p_type_name'];?>">

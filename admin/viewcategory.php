...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="viewcategory.php">View_category</a>
        </li>
    </ul>
</div>
<div class="row">
            ...
            <table class="table table-striped">
                ...
                <?php
                    if (mysqli_num_rows($rs)>0) 
                    {
                        ...
                        {
                            $qry1 = "SELECT * FROM parcel_type WHERE p_type_id=id AND isactive=1";
                            $rs1 = mysqli_query($conn,$qry1);
                ?>
                <tr>
                    <td><?php echo $row['p_type_id']; ?></td>
                    <td><?php echo $row['p_type_name']; ?></td>
                    <td><a href="editcategory.php?id=<?php echo $row['p_type_id'];?>">Edit</a></td>
                    <td><a href="deletecategory.php?id=<?php echo $row['p_type_id'];?>">Delete</a>
                </tr>
                <?php
                        }
                    }

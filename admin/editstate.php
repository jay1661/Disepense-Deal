<?php 
    ...
    $id=$_GET['id'];
    $qrys="SELECT * FROM state where state_id=$id";
...
<div class="row">
    <div class="col-md-12">
        <form name="qryform" id="qryform" method="post" action="updatestate.php" onsubmit="return(validate());" novalidate="novalidate">
            <div class="form-group">
                <label>State:</label>
                <input type="text" class="form-control" id="name" placeholder="Enter State" name="sname" value="<?php echo $rows['sname']; ?>">

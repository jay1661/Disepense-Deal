...
<div class="row">
    <div class="col-md-12">
        <form name="qryform" id="qryform" method="POST" action="category.php" onsubmit="return(validate());" novalidate="novalidate">
            <div class="form-group">
                <label>Type:</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Parcel Type" name="ptype">

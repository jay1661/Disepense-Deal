<?php
    ...
    $qry = "SELECT * FROM contact WHERE isactive=1";
...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="viewcontact.php">View_contact</a>
        </li>
    </ul>
</div>
<div class="row">
            ...
            <table class="table table-striped">
                ...
                <?php
                    if (mysqli_num_rows($rs)>0) 
                    {
                        ...
                        {
                            $qry1 = "SELECT * FROM contact WHERE isactive=1";
                ...
                <tr>
                    ...
                    <td><a href="deletecontact.php?id=<?php echo $row['contact_id'];?>">Delete</a></td>
                </tr>
                <?php
                        }
                    }

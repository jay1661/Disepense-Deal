...
<div class="row">
    <div class="col-md-12">
        <form name="qryform" id="qryform" method="post" action="seqque.php" onsubmit="return(validate());" novalidate="novalidate">
            <div class="form-group">
            </div>
            <div class="form-group">
                <label>Question:</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Sequrity Question" name="name">
            </div>               

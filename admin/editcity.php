<?php
    ...
    $id=$_GET['id'];
    $qryc="SELECT * FROM city where city_id=$id";
...
<div class="row">
    <div class="col-md-12">
        <form name="qryform" id="qryform" method="POST" action="updatecity.php" onsubmit="return(validate());" novalidate="novalidate">
            ...
            <div class="form-group">
                <label>City:</label>
                <input type="text" class="form-control" placeholder="Enter City" name="cityname" value="<?php echo $rowc['cname'];?>">

    ...
    <div class="container">       
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
               <form action="userpro.php" method="POST" enctype="multipart/form-data" class="contact-form form-group"> 
                ...
                <input type="password" name="upass" placeholder="Confirm your password" class="form-control" required><br><br>
                <p>Photo:</p>

            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div class="single-blog-post-item">
                    <div class="blog-img-holder">
                        <img src="img/blog-page/1.jpg" alt="img">
                    </div>
                    <div class="blog-content-box">
                        ...
                        <div class="single-blog-text">
                            <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consect etur, adipisci velit, sed quia non numquam eius.</p>
                ...
                <div class="single-blog-post-item">
                    <div class="blog-img-holder">
                        <img src="img/blog-page/2.jpg" alt="img">
                    </div>
                    <div class="blog-content-box">
                        <div class="single-bolg-title">
                            <h3>heading of blogs</h3>
                ...
                <div class="single-blog-post-item">
                    <div class="blog-img-holder">
                        <img src="img/blog-page/3.jpg" alt="img">
                    </div>
                    <div class="blog-content-box">
                        <div class="single-bolg-title">
                            <h3>heading of blogs</h3>
                ...
                <div class="single-blog-post-item">
                    <div class="blog-img-holder">
                        <img src="img/blog-page/4.jpg" alt="img">
                    </div>
                    <div class="blog-content-box">
                        <div class="single-bolg-title">
                            <h3>heading of blogs</h3>
                ...
                <div class="sidebar-widget-items pl20">
                    ...
                    <div class="widget">
                        <div class="category-menu">
                            <h4 class="widget-title blue">Category</h4>
                            <ul class="category-list">
                                ...
                                <li><a href="#">Human Right Law</a></li>
                            </ul>
                        </div>
                    </div><!-- widget --> 
                    <div class="widget">
                        <div class="related-post">
                            <h4 class="widget-title blue">Popular Posts</h4>
                    ...
                    <div class="widget text-widget">
                        <h4 class="widget-title blue">Text Widget</h4>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
                    </div>               
                    <div class="widget">
                        <h4 class="widget-title blue">Tags Widget</h4>
                        <div class="tag-cloud">
                            <a href="#">law</a>
                            <a href="#">tablet</a>

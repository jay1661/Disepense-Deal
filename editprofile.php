<?php
    ...
    $id=$_GET['id'];
    $qrya="SELECT * FROM driver_registration where d_id=$id";
...
<section class="page-title inner-baner">
    <div class="container">
        ...
        <ul class="bread-crumb clearfix">
            ...
            <li class="active">Become Driver</li>
        </ul>
    </div>
</section>
<!--End Page Title-->
    ...
    <div class="container">       
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
               <form action="updateprofile.php" class="contact-form" enctype="multipart/form-data" method="post"> 
                <center><h1>Driver Registration</h1></center>
                <p>Name:</p>
                <input type="text" name="name" placeholder="Enter Your Name" class="form-control" value="<?php echo $rowa['d_name'] ?>"><br>
                <p>Password:</p>
                <input type="password" name="pass" placeholder="Enter Your password" class="form-control" value="<?php echo $rowa['d_password'] ?>"><br><br>
                <p>Photo:</p>
                <input type="file" name="profile" class="form-control">

                <br>
                <p>Email:</p>
                <input type="email" name="mail" placeholder="Enter Your Email" class="form-control" value="<?php echo $rowa['d_email'] ?>"><br>
                <p>Mobile No.</p>
                <input type="text" name="num" placeholder="Enter Your Phone Number" value="<?php echo $rowa['d_phone_no'] ?>">
                <p>Address:</p>
                <textarea name="message" placeholder="Enter Your Address"><?php echo $rowa['d_address'] ?></textarea><br><br>
                <p>Area:</p>

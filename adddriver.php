    ...
    <div class="container">       
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
               <form action="driverpro.php" class="contact-form" enctype="multipart/form-data" method="post"> 
                ...
                <p>Mobile No.</p>
                <input type="text" name="num" placeholder="Enter Your Phone Number" required>
                <p>Licence:</p>
                ...
                <select name="seid" class="form-control" required>
                ...
                <p>Driver type</p>
                <label class="container1">Permanent
                <input type="radio" checked="checked" name="permanent" value="1">
                <span class="checkmark"></span>
                </label>
                <label class="container1">Not-Permanent

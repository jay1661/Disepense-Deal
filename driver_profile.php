<?php
    ...
    $qry4 = "SELECT * FROM parcel_booking_detail WHERE d_id= '".$id."' AND isactive=0";
            ...
            <div class="row" style="padding: 20px;">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    ...
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <center><h2>My Added Trip Details</h2></center>
                                ...
                                <table class="table table-striped" style="border: 2px solid #ddd;">
                                    ...
                                    <?php
                                        ...
                                        {
                                            while ($row8 = mysqli_fetch_assoc($rs1))
                                            {
                                                $sid = $row8['source'];
                                                ...
                                                $qry3 = "SELECT * FROM city WHERE city_id='".$row8['destination']."'";
                                    ...
                                    <tr style="font-size: 12px;">
                                        ...
                                        <td><?php echo $row8['vehicle_model'];?></td>
                                        <td><?php echo $row8['vehicle_no'];?></td>
                                        <td><img src="img/vehicle/<?php echo $row8['vehicle_photo'];?>" width="50px" height="50px"></td>
                                        <td><?php echo $row8['trip_time'];?></td>
                                        <td><a href="parcel_booking_detail.php?bid=<?php echo $row8['trip_id']; ?>">Parcel_info</a></td>
                                    </tr>
                                <?php
                                        }
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped" style="border: 2px solid #ddd;">
                                    ...
                                    <tr style="font-size: 14px;">
                                        ...
                                        <td><a href="accept.php?id1=<?php echo $row3['booking_id'];?>">Accept</a></td>

...
<!--End Page Title-->
<div class="sections-wrapper sec-pad img-fluid"  style="background-image: linear-gradient(#5533FF,white,#5533FF);background-repeat: no-repeat;background-position: center;">
    <div class="container">       
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
             <form action="checklogin.php" method="POST" class="contact-form">
                <fieldset>
                    <div class="alert">
                ...
                <input type="password" name="pass" placeholder="Enter Your password" class="form-control">
                    ...
                    <div class="input-group input-group-lg" style="float: left;">
                        <a href="adduser.php">Not User?  Register here</a>
                    </div><br>
                    <button type="submit" class="theme-btn-orng btn-lg" name="btn_sb"><span>Login</span></button>
                </fieldset>
            </form>
        </div>
        <!-- col -->
